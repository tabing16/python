...
parser.add_argument("-s", "--start", nargs='+', required=True, type=dt_regex_validation
                    , help="start period of the reading. in format DD-MM-YYYY HH24:MI. For example: 01-03-2019 00:15")
parser.add_argument("-e", "--end", nargs='+', required=True, type=dt_regex_validation
                    , help="end period of the reading. in format DD-MM-YYYY HH24:MI. For example: 01-03-2019 00:15")
